...
.card("Under a bush\nArchers#(North, North)",1,BrownMushroom,1) // north,north = 1
.card("In the grass\nArchers#(North, North).aimTo(South)",2,BrownMushroom,2) // north, south = 2
.card("Between the rocks\nArchers#(North, South)",2,BrownMushroom,3)
.card("Near a tree\nArchers#(North, West.turn).aimTo(South)",2,BrownMushroom,4)
.card("Near a rock\nArchers#(North, South.reverse).aimTo(South)",2,BrownMushroom,5)
.card("Near a pond\nArchers#(South, North).aimTo(South)",3,BrownMushroom,6) // south, south =3
.card("Near a fallen tree\nArchers#(South, South)",3,BrownMushroom,7)
...
.card("Inside a tree hole\nArchers#(South, North).headTo(South)",4,BrownMushroom,10) // south, north =4
.card("Near the cliff\nArchers#(South, North)",4,BrownMushroom,11)
